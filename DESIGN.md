...
This is an engineering explorer, not a landing page. The contract below is the source of truth for task 8/9 implementation: visual values are tokens, layout responsibilities have names, and every state keeps the same data contract visible.
